...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  launchExternalApp: (path, args) => ipcRenderer.invoke('app:launchExternal', path, args),
  ...
  setProxyForSession: (partition, proxyConfig) => ipcRenderer.invoke('session:set-proxy', partition, proxyConfig),
  clearProxyForSession: (partition) => ipcRenderer.invoke('session:clear-proxy', partition),
});